...
<body>
    ...
    <div class= "content">
        ...
        <?php
            ...
            if (!$fname || !$lname || !$studentID || !$password)
            {
            ...
            else
            {
                ...
                $query = "INSERT into Person VALUES( '', '$fname', '$lname', '$studentID', PASSWORD('$password'), 1)";
                $result = $db->query($query);
                
                if ($result) 
                {
                  echo "<br><h3>".$fname." ".$lname." has been added to the Student Body!</h3>";
